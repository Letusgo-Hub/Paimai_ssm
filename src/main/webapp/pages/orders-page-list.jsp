							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc sorting_asc_disabled">拍卖品编号</th>
								...
								<tbody>
									...
									<c:forEach items="${orders}" var="orders">
										...
										<tr>
											...
											<td>${orders.maxmoney }</td>
											<td>${orders.orderTime }</td>
											<td class="text-center">${orders.orderStatus }</td>
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/delete.do?id=${orders.id}'">删除订单</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
