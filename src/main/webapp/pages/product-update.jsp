                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right"
                                       id="datepicker-a3" name="pendtime"  placeholder="${product.pendtime}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="startbid"
                                   placeholder="${product.startbid}" value="">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%"
                                ...
                                <option value="休闲美容">休闲美容</option>
                                <option value="珠宝">珠宝</option>
                                <option value="汽配">汽配</option>
                        ...
                        <div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="其他信息"
                                      name="pdescribe" placeholder="${product.pdescribe}"></textarea>
                        </div>
