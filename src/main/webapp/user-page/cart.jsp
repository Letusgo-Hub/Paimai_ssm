			...
			<div class="section">
				...
				<div class="line">
					<div class="fullwidth margin-bottom-20">
						...
						<p class="text-center">以下是您购买拍卖的商品</p>
				...
				<div class="line">
					...
					<div class="s-12 m-12 l-8">
                        <c:forEach items="${orderList}" var="order" begin="0" step="2" end="30">
						<div class="fullwidth cart-item">
							<div class="s-12 m-4 l-3 cart-item-image">
								<img src="${pageContext.request.contextPath}/${order.picurl}" alt="">
							</div>
							<div class="s-12 m-8 l-9 cart-item-detail">
								<h4>${order.id}</h4>
								<p>
									价格: <span class="text-primary">${order.maxmoney}</span>
								</p>
								<p>
									状态：${order.succordef}
								</p>
					...
					<div class="s-12 m-12 l-4 margin-m-top-60 padding border-1">
						<p class="margin-bottom text-size-16">提示: <span class="right">请耐心等待拍卖行工作人员联系您支付拍卖成功的账单</span></p>
					</div>
