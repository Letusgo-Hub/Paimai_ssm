									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/delete.do?id=${user.id}" class="btn bg-olive btn-xs">删除用户</a>
												<a href="${pageContext.request.contextPath}/user/dongjie.do?id=${user.id}" class="btn bg-olive btn-xs">冻结/解冻</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
