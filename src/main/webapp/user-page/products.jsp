        ...
        <div id="page-main-content" >
			...
			<div class="section">
				...
				<div class="line">
					<div class="margin">
						<div class="fullwidth">
							<h1 class="text-center">重点拍卖</h1>
							<p class="text-center">各类产品的重点拍卖</p>
									...
									<figure class="imghvr-reveal-down">
										...
										<figcaption>
											<div class="product-hover-content">
												<div class="btn-box">
													<a href="${pageContext.request.contextPath}/product/uFindProductById.do?id=${product.id}" class="btn">参与竞拍</a>
												</div>
											</div>
										</figcaption>
									</figure>
