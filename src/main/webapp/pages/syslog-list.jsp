		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							总共${pageInfo.pages}页，共${pageInfo.getTotal()}条数据。 每页
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=1&${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum-1}&${pageInfo.pageSize}">上一页</a></li>
							<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
								<li><a href="#">${pageNum}</a></li>
							</c:forEach>
							<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum+1}&${pageInfo.pageSize}">下一页</a></li>
							<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pages}&${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
